...
NT_logeV,NT_logSyp,NT_logIC,NT_logpIC,NT_logpp,NT_logpg,NT_logNotAbs, NT_logAbs = np.loadtxt('lumNonThermal.dat',unpack=True,skiprows=1)
...
ax1.plot(NT_logeV,NT_logpIC,label='pIC',lw=2,ls='--',marker='*',markevery=4,markersize=markersize)
