...
ProjectPath            :=/home/flor/projects/github/radproc_linux/lib/fluminosities
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/flor/projects/github/radproc_linux/ionTori/.build-debug/fluminosities"
...
$(IntermediateDirectory)/luminosityIC.cpp$(ObjectSuffix): luminosityIC.cpp $(IntermediateDirectory)/luminosityIC.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/flor/projects/github/radproc_linux/lib/fluminosities/luminosityIC.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/luminosityIC.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/luminositySynchrotron.cpp$(ObjectSuffix): luminositySynchrotron.cpp $(IntermediateDirectory)/luminositySynchrotron.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/flor/projects/github/radproc_linux/lib/fluminosities/luminositySynchrotron.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/luminositySynchrotron.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/opticalDepthSSA.cpp$(ObjectSuffix): opticalDepthSSA.cpp $(IntermediateDirectory)/opticalDepthSSA.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/flor/projects/github/radproc_linux/lib/fluminosities/opticalDepthSSA.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/opticalDepthSSA.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/thermalBremss.cpp$(ObjectSuffix): thermalBremss.cpp $(IntermediateDirectory)/thermalBremss.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/flor/projects/github/radproc_linux/lib/fluminosities/thermalBremss.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/thermalBremss.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/thermalSync.cpp$(ObjectSuffix): thermalSync.cpp $(IntermediateDirectory)/thermalSync.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/flor/projects/github/radproc_linux/lib/fluminosities/thermalSync.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/thermalSync.cpp$(ObjectSuffix) $(IncludePath)
