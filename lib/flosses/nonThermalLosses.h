...
double BohmDiffusionCoeff(double E, double B);   //en [s]^-1
...
double diffusionTimePerpendicular(double E, double h, double B);   //en [s]^-1
...
double relaxTime_e(double, double, double);
double relaxTime_p(double, double, double);